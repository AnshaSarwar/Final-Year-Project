        ...
        <CardBody className="px-6">
          {uploadSuccess ? (
            <div className="flex flex-col gap-2">
              {Object.values(fileStatus).some((status) => status !== 'Uploaded') ? (
                <span className="text-xs text-red-500">Upload completed, but with errors.</span>
              ) : null}
          ...
          <button
            className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mt-12"
            >
            See Existing Books
          </button>
</Link>
